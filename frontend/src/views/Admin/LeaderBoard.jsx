      ...
      <div className='flex flex-col min-h-screen bg-gray-50'>
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="w-full max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-4 text-gray-800">Leaderboard Not Generated</h2>
            <p className="text-gray-600 mb-6 text-lg">The leaderboard for this contest has not been generated yet.</p>
            <button 
              onClick={handleGenerateLeaderboard}
              className="bg-purple-500 hover:bg-purple-600 text-white font-bold py-3 px-6 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
            >
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-extrabold text-center text-gray-900 mb-8">Leaderboard</h2>
